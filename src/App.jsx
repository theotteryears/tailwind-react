  ...
  return (
    <div className="grid grid-cols-6">
      ...
      <p className="col-span-1 col-start-2 m-3 p-3 text-center">
        ...
        provident, recusandae nemo fuga accusantium dolor nulla impedit
      ...
      <p className="col-span-1 col-start-5 m-3 p-3 text-center">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi
        accusantium necessitatibus officia quam cum. Tempore nisi voluptates
